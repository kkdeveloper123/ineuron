@extends('admin.index')
@section('title', 'DevsWeb : Add SEO Content ')
@section('content')
                            ...
                            <div class="col-lg-4">
                                <div class="page-header-breadcrumb">
                                    <ul class="breadcrumb-title">
                                        ...
                                        <li class="breadcrumb-item"><a href="{{ route('admin.seoPagesIndex') }}">SEO Content</a>
                                        </li>
                            ...
                            <div class="col-sm-6">
                                <div class="card">
                                    ...
                                    <div class="card-block">
                                        <form method="post" action="{{ route('admin.insertSeoContent') }}"
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" name="og_url" class="form-control"
                                                        placeholder="OG Url" value="{{ old('og_url')}}">
                                                    @error('og_url')
                                                        <div class="form-valid-error">{{ $message }}</div>
                                                    @enderror
                                                </div>
                                            ...
                                            <div class="form-group row">
                                                <div class="col-sm-12">
                                                    ...
                                                    <input type="text" name="og_description" class="form-control"
                                                        placeholder="og:description" value="{{ old('og_description')}}">
